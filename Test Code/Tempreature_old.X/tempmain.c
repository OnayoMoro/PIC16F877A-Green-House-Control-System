...
# define DQ RB0                              //define 18B20 data PORT                    
# define DQ_DIR TRISB0                       //define 18B20 D PORT direct register       
...
void main()
{
   //init_temp();                       //call 0system initialize function                                                                                                                                 
   while(1)                                                                                                                                                                                        
     {                                                                                                                                                                                             
